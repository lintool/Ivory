...
public class PostingsListDocSortedPositionalTest {
	...
	public void testBasic1() throws IOException {
		...
		PostingsListDocSortedPositional postings2 = PostingsListDocSortedPositional.create(postings
				.serialize());
	...
	public void testBasic2() throws IOException {
		...
		PostingsListDocSortedPositional postings3 = PostingsListDocSortedPositional
				.create(postings2.serialize());
	...
	public void testMerge1() throws IOException {
		...
		PostingsListDocSortedPositional postings1b = PostingsListDocSortedPositional
				.create(postings1a.serialize());
		...
		PostingsListDocSortedPositional postings2b = PostingsListDocSortedPositional
				.create(postings2a.serialize());
