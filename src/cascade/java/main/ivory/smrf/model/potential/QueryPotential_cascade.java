 ...
 * 
 */
public class QueryPotential_cascade extends QueryPotential {

	//If it's a term feature, store its positions at current document in the postings list
	private int [] positions; 
	private int document_length; 

	public QueryPotential_cascade() {
	}

	public QueryPotential_cascade(RetrievalEnvironment env, ExpressionGenerator generator,
