...
/**
 * 
 * A space and time-efficient implementation of Signature. This class is basically a
 * WritableComparable wrapper around the Bits class with many functionalities such as computing
 * hamming distance very efficiently (using bitwise operations).
 * 
 * @author ferhanture
 * 
 */
