 ...
 * @author Nima Asadi
 */
public class DocumentVectorSlidingWindow {
  private static final Logger LOGGER = Logger.getLogger(DocumentVectorSlidingWindow.class);
  ...
  public DocumentVectorSlidingWindow(RetrievalEnvironment env, FileSystem fs) {
    this.env = env;
    this.fs = fs;
  }
  ...
  public void computeFeatures(int[] doc, int[] qterms, int[] hashedTerms, Feature[] features, float[] fvalues) {
