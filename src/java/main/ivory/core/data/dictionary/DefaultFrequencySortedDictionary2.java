 ...
 * @author Jimmy Lin
 */
public class DefaultFrequencySortedDictionary2 implements FrequencySortedDictionary {
   ...
   */
  public DefaultFrequencySortedDictionary2(Path prefixPath, Path idsPath, Path idToTermPath,
  ...
  public static void main(String[] args) throws Exception {
    ...
    DefaultFrequencySortedDictionary2 dictionary =
        new DefaultFrequencySortedDictionary2(termsFilePath, termIDsFilePath, idToTermFilePath, fs);
