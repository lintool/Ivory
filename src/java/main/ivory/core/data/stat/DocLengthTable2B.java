...
public class DocLengthTable2B implements DocLengthTable {
	...
	public DocLengthTable2B(Path file, FileSystem fs) throws IOException {
		...
		for (int i = 1; i < sz; i++) {
			...
			lengths[i] = l > (Short.MAX_VALUE - Short.MIN_VALUE) ? Short.MAX_VALUE : (short) (l + Short.MIN_VALUE);
			docCount++;
	...
	public static void main(String[] args) throws Exception {
		...
		DocLengthTable2B lengths = new DocLengthTable2B(new Path(args[0]), FileSystem.get(new Configuration()));
