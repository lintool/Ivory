...
public abstract class Tokenizer {
  ...
  /**
   * Method to return number of tokens in text. Subclasses may override for more efficient
   * implementations.
   * 
  ...
  /**
   * Method to remove non-unicode characters from token, to prevent errors in the preprocessing
   * pipeline. Such cases exist in German Wikipedia.
   * 
   * @param token token to check for non-unicode character
   * @return token without the non-unicode characters
   */
