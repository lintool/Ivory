  ...
  public static Tokenizer createTokenizer(String lang, String modelPath, VocabularyWritable vocab) {
    ...
    try {
      if (lang.equals("zh")) {
        ...
        conf.set("Ivory.TokenizerModel", modelPath); // can't use tokenizer file because it points
                                                     // to local path, which isn't supported in
                                                     // StanfordTokenizer at the moment
        fTok.configure(conf);
        return fTok;
