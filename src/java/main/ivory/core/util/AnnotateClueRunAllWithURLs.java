...
public class AnnotateClueRunAllWithURLs extends Configured implements Tool {
	...
	private static class MyMapper extends NullMapper {
		public void run(JobConf conf, Reporter reporter) throws IOException {
			...
			indexes[0].loadIndex("/shared/ClueWeb09/collection.compressed.block/findex.en.01.dat",
					"/shared/ClueWeb09/docno-mapping.dat");

			indexes[1] = new ClueWarcForwardIndex();
			indexes[1].loadIndex("/shared/ClueWeb09/collection.compressed.block/findex.en.02.dat",
					"/shared/ClueWeb09/docno-mapping.dat");

			indexes[2] = new ClueWarcForwardIndex();
			indexes[2].loadIndex("/shared/ClueWeb09/collection.compressed.block/findex.en.03.dat",
					"/shared/ClueWeb09/docno-mapping.dat");

			indexes[3] = new ClueWarcForwardIndex();
			indexes[3].loadIndex("/shared/ClueWeb09/collection.compressed.block/findex.en.04.dat",
					"/shared/ClueWeb09/docno-mapping.dat");

			indexes[4] = new ClueWarcForwardIndex();
			indexes[4].loadIndex("/shared/ClueWeb09/collection.compressed.block/findex.en.05.dat",
					"/shared/ClueWeb09/docno-mapping.dat");

			indexes[5] = new ClueWarcForwardIndex();
			indexes[5].loadIndex("/shared/ClueWeb09/collection.compressed.block/findex.en.06.dat",
					"/shared/ClueWeb09/docno-mapping.dat");

			indexes[6] = new ClueWarcForwardIndex();
			indexes[6].loadIndex("/shared/ClueWeb09/collection.compressed.block/findex.en.07.dat",
					"/shared/ClueWeb09/docno-mapping.dat");

			indexes[7] = new ClueWarcForwardIndex();
			indexes[7].loadIndex("/shared/ClueWeb09/collection.compressed.block/findex.en.08.dat",
					"/shared/ClueWeb09/docno-mapping.dat");

			indexes[8] = new ClueWarcForwardIndex();
			indexes[8].loadIndex("/shared/ClueWeb09/collection.compressed.block/findex.en.09.dat",
					"/shared/ClueWeb09/docno-mapping.dat");

			indexes[9] = new ClueWarcForwardIndex();
			indexes[9].loadIndex("/shared/ClueWeb09/collection.compressed.block/findex.en.10.dat",
					"/shared/ClueWeb09/docno-mapping.dat");
