...
public class PreprocessAquaintNGram extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(PreprocessAquaintNGram.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new Configuration(), new PreprocessAquaintNGram(), args);
  }
}
