...
import ivory.core.tokenize.OverlappingNGramTokenizer;
...
public class PreprocessAquaint2NGram extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(PreprocessAquaint2NGram.class);
  ...
  public int run(String[] args) throws Exception {
    ...
    LOG.info(" - Tokenizer: " + OverlappingNGramTokenizer.class.getCanonicalName());
    ...
    conf.set(Constants.Tokenizer, OverlappingNGramTokenizer.class.getCanonicalName());
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new Configuration(), new PreprocessAquaint2NGram(), args);
  }
}
