...
public class PreprocessClueWebEnglish extends Configured implements Tool {
	...
	private static int printUsage() {
		System.out.println("usage: [input-path] [index-path] [segment-num] [num-of-mappers] [num-of-reducers]");
	...
	public int run(String[] args) throws Exception {
		...
		conf.set("Ivory.Tokenizer", ivory.core.tokenize.GalagoTokenizer.class.getCanonicalName());
