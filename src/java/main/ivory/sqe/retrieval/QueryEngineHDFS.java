...
public class QueryEngineHDFS extends Configured implements Tool  {

	  private static final Logger LOG = Logger.getLogger(QueryEngineHDFS.class);
	  ...
	  public int run(String[] args) throws Exception {
	    ...
	    JobConf conf = new JobConf(QueryEngineHDFS.class);
	    conf.setJobName("QueryEngineHDFS");
	  ...
	  public QueryEngineHDFS() {}

	  public static void main(String[] args) throws Exception {
	    ToolRunner.run(new QueryEngineHDFS(), args);
	  }
