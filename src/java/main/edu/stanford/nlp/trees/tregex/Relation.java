...
abstract class Relation implements Serializable {
  ...
  public static void main(String[] args) {
    ...
    relations.add(new UnbrokenCategoryDominates("NP", basicCatFunction));
    relations.add(new UnbrokenCategoryDominates("VP", basicCatFunction));
    relations.add(new UnbrokenCategoryIsDominatedBy("NP", basicCatFunction));
    relations.add(new UnbrokenCategoryIsDominatedBy("VP", basicCatFunction));
