...
public class TypedDependency implements Comparable<TypedDependency>, Serializable {
  ...
  public String toString() {
    if(gov!=null && gov.label().get(TextAnnotation.class)!=null) {
      StringBuilder str = new StringBuilder();
      str.append(reln).append("(").append(gov.label().toString("text-index")).append(", ").append(dep.label().toString("text-index")).append(")");
      return str.toString();
    }
