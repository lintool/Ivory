...
public class CoreAnnotations {
   ...
   * tree. See {@link edu.stanford.nlp.trees.Tree#indexSpans(int)}. This annotation counts tokens.
   ...
   * tree.  See {@link edu.stanford.nlp.trees.Tree#indexSpans(int)}. This annotation counts
