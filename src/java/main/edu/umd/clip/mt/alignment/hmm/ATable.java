package edu.umd.clip.mt.alignment.hmm;
...
public class ATable implements Writable, Cloneable {
	...
	/* (non-Javadoc)
	 * @see edu.umd.clip.mt.alignment.hmm.IATable#clear()
	 */
	public void clear() {
		for (int i = 0; i < data.length; i++) {
			float[] row = data[i];
	...
	/* (non-Javadoc)
	 * @see edu.umd.clip.mt.alignment.hmm.IATable#get(int, char)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.umd.clip.mt.alignment.hmm.IATable#get(int, char, int)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.umd.clip.mt.alignment.hmm.IATable#add(int, char, int, float)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.umd.clip.mt.alignment.hmm.IATable#add(int, char, float)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.umd.clip.mt.alignment.hmm.IATable#getCoord(int, char)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.umd.clip.mt.alignment.hmm.IATable#plusEquals(edu.umd.clip.mt.alignment.hmm.ATable)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.umd.clip.mt.alignment.hmm.IATable#normalize()
	 */
