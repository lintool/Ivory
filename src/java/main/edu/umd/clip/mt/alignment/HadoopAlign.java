...
import edu.umd.clip.mt.alignment.aer.ReferenceAlignment;
import edu.umd.clip.mt.alignment.hmm.ATable;
import edu.umd.clip.mt.alignment.hmm.HMM;
import edu.umd.clip.mt.alignment.hmm.HMM_NullWord;
import edu.umd.clip.mt.alignment.model1.Model1;
import edu.umd.clip.mt.alignment.model1.Model1_InitUniform;
import edu.umd.clip.mt.ttables.TTable;
...
import edu.umd.clip.mt.CorpusVocabNormalizerAndNumberizer;
import edu.umd.clip.mt.PServer;
import edu.umd.clip.mt.PServerClient;
...
//	public static String root = "/user/fture";
...
//			conf.setOutputFormat(SequenceFileOutputFormat.class);
	...
	public static void main(String[] args) throws IOException {
		...
		if (args.length < 6) {
			System.err.println("usage: [input-path] [root-path] [src-lang] [trg-lang] [number-of-model1-iters] [number-of-hmm-iters] (local)\nUse 5th argument only for local runs.");
			return;
		}
...
//		TTable tt = new TTable_monolithic_IFAs(FileSystem.get(hac), hac.getTTablePath(), true);
