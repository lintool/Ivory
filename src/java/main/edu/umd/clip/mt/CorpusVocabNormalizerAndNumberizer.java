...
import edu.umd.clip.mt.alignment.HadoopAlignConfig;
import edu.umd.clip.mt.alignment.aer.ReferenceAlignment;
import edu.umd.clip.mt.corpora.Chunk;
import edu.umd.clip.mt.corpora.Language;
import edu.umd.clip.mt.corpora.LanguagePair;
import edu.umd.clip.mt.corpora.ParallelChunk;
import edu.umd.clip.mt.corpora.ParallelCorpusReader;
...
public class CorpusVocabNormalizerAndNumberizer {
	...
	implements Mapper<Text, Text, Text, PhrasePair> {
		...
		public void map(Text key, Text value, 
			...
			edu.umd.clip.mt.PhrasePair b = new PhrasePair(f,e);
