 ...
 * @author redpony
 *
 * TTable is the data structure that stores the translation probability table. it has all useful methods for use in CLIR techniques
 * it is also pretty efficient as it stores all words as integers and without any redundant storage
 * 
 * @author ferhanture
 */
