...
public class EnAr_TREC02 {
  ...
  private static Map<Integer,float[]> expectedMAPs = new HashMap<Integer,float[]>();{ 
    expectedMAPs.put(0, new float[]{0.3020f, 0.2497f, 0.2475f}); 
    expectedMAPs.put(1, new float[]{0.2824f, 0.2489f, 0.2488f}); 
    expectedMAPs.put(2, new float[]{0.2931f, 0.2422f, 0.2551f}); 
  };
  private static float expectedTokenMAP = 0.2714f;
  private static int numTopics = 50;

  private static Map<Integer, String[]> phrase_p005_c95_Ar_TREC02_AP = new HashMap<Integer, String[]>();
  {
    phrase_p005_c95_Ar_TREC02_AP.put(0, new String[] {
    ...
    phrase_p005_c95_Ar_TREC02_AP.put(1, new String[] {
    ...
    phrase_p005_c95_Ar_TREC02_AP.put(2, new String[] {
  ...
  private static Map<Integer, String[]> Nbest_p005_c95_Ar_TREC02_AP = new HashMap<Integer, String[]>();
  {
    Nbest_p005_c95_Ar_TREC02_AP.put(0, new String[] {
    ...
    Nbest_p005_c95_Ar_TREC02_AP.put(1, new String[] {
    ...
    Nbest_p005_c95_Ar_TREC02_AP.put(2, new String[] {
  ...
  private static Map<Integer, String[]> Onebest_p005_c95_Ar_TREC02_AP = new HashMap<Integer, String[]>();
  {
    Onebest_p005_c95_Ar_TREC02_AP.put(0, new String[] {
    ...
    Onebest_p005_c95_Ar_TREC02_AP.put(1, new String[] {
    ...
    Onebest_p005_c95_Ar_TREC02_AP.put(2, new String[] {
  ...
  //  private static String[] Gridbest_p005_c95_Ar_TREC02_AP = phrase_p005_c95_Ar_TREC02_AP_one2none;
  ...
  public static void verifyAllResults(Set<String> models,
    ...
    g.put("en-ar.token_10-0-100-100_0", new GroundTruth(Metric.AP, numTopics, baseline_token_p005_c95_Ar_TREC02_AP, expectedTokenMAP));

    for (int heuristic=0; heuristic <= 2; heuristic++) {
      g.put("en-ar.phrase_10-0-0-100_" + heuristic, new GroundTruth(Metric.AP, numTopics, phrase_p005_c95_Ar_TREC02_AP.get(heuristic), expectedMAPs.get(heuristic)[0]));
      g.put("en-ar.1best_1-0-0-100_" + heuristic, new GroundTruth(Metric.AP, numTopics, Onebest_p005_c95_Ar_TREC02_AP.get(heuristic), expectedMAPs.get(heuristic)[1]));
      g.put("en-ar.10best_10-100-0-100_" + heuristic, new GroundTruth(Metric.AP, numTopics, Nbest_p005_c95_Ar_TREC02_AP.get(heuristic), expectedMAPs.get(heuristic)[2]));
    }
  ...
  public static void main(String[] args) {
    ...
    HMapSFW tenbestAPMap = array2Map(Nbest_p005_c95_Ar_TREC02_AP.get(2));
    HMapSFW onebestAPMap = array2Map(Onebest_p005_c95_Ar_TREC02_AP.get(1));
    HMapSFW phraseAPMap = array2Map(phrase_p005_c95_Ar_TREC02_AP.get(0));
