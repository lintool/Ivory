...
public class Web09catB_CIKM2010_Title_Joint {

	private static final Logger sLogger = Logger.getLogger(Web09catB_CIKM2010_Title_Joint.class);
	...
	public void runRegression() throws Exception {
		...
		String[] params = new String[] { "docs/data/clue/run.clue.CIKM2010.title.joint.xml",
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(Web09catB_CIKM2010_Title_Joint.class);
	}
}
