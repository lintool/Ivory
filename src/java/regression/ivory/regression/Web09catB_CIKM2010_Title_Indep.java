...
public class Web09catB_CIKM2010_Title_Indep {

	private static final Logger sLogger = Logger.getLogger(Web09catB_CIKM2010_Title_Indep.class);
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(Web09catB_CIKM2010_Title_Indep.class);
	}
}
