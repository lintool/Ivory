...
public class VerifyLocalTrec45PositionalIndexIP extends IntegrationTestBaseTrec45 {
  ...
  public static junit.framework.Test suite() {
    return new JUnit4TestAdapter(VerifyLocalTrec45PositionalIndexIP.class);
  }
}
