...
public class Gov2_CIKM2010_Desc_Indep {

	private static final Logger sLogger = Logger.getLogger(Gov2_CIKM2010_Desc_Indep.class);
	...
	public void runRegression() throws Exception {
		...
		String[] params = new String[] { "docs/data/gov2/run.gov2.CIKM2010.desc.indep.xml",
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(Gov2_CIKM2010_Desc_Indep.class);
	}
}
