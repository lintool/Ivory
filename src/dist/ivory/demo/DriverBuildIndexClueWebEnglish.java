...
import ivory.collection.clue.BuildClueWarcForwardIndex;
 ...
 *
 */
public class DriverBuildIndexClueWebEnglish extends Configured implements Tool {
	private static final Logger sLogger = Logger.getLogger(DriverBuildIndexClueWebEnglish.class);
	...
	private DriverBuildIndexClueWebEnglish() {
	}
	...
	public int run(String[] args) throws Exception {
		...
		sLogger.info("Tool name: DriverBuildIndexClueWebEnglish");
		...
		BuildClueWarcForwardIndex findexTool = new BuildClueWarcForwardIndex(config);
		findexTool.run();
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new DriverBuildIndexClueWebEnglish(), args);
		System.exit(res);
	}
}
