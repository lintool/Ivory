 ...
 */
public abstract class NLineServerMapper extends MapReduceBase implements
	...
	public void map(LongWritable key, Text value,
		...
		run(key, value, mConf, reporter);
	}

	public abstract void run(LongWritable key, Text value, JobConf conf, Reporter reporter) throws IOException;
}
