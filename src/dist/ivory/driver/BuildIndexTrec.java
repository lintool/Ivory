 ...
 * 
 */
public class BuildIndexTrec extends Configured implements Tool {
	private static final Logger sLogger = Logger.getLogger(BuildIndexTrec.class);

	private BuildIndexTrec() {
	}
	...
	public int run(String[] args) throws Exception {
		...
		sLogger.info("Tool: BuildIndexTrec");
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new BuildIndexTrec(), args);
		System.exit(res);
	}
}
