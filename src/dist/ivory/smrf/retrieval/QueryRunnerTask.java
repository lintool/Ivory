 ...
 *
 */
public class QueryRunnerTask implements Callable<Accumulator []> {
	...
	private static final Logger sLogger = Logger.getLogger(QueryRunnerTask.class);
	 ...
	 * @param expander
	 */
	public QueryRunnerTask(String query, MRFBuilder builder, MRFExpander expander) {
		mQuery = query;
		mBuilder = builder;
		mExpander = expander;
	}
