...
public class TermIdMap {

	private PrefixEncodedTermSet mDictionary = new PrefixEncodedTermSet();
	private int[] mIds;
	private int[] mIdToTerm;

	public TermIdMap(Path prefixSetPath, Path idsPath, Path idToTermPath, FileSystem fileSys)
			throws IOException {
